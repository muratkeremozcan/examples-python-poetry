...
def test_reading_speed(benchmark, read_df):
    ...
    # Optional: Add performance-specific assertions
    # For example, ensure the operation takes less than 1ms (time in seconds)
    assert benchmark.stats['mean'] < 0.001, "Grouping operation is too slow"
