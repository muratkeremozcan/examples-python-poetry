...
class Product:
    ...
    def add_product(cls, name, category, quantity, price, supplier):
        ...
        cls._id_counter += 1
        new_product = Product(cls._id_counter, name, category, quantity, price, supplier)
...
class Order:
    def __init__(self, order_id, products=None, customer_info=None):
        ...
        self.products = products if products is not None else []  # list of (product_id, quantity)
